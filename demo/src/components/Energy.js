...
const CarbonFootprintCalculator = ({ updateTotalElectricityConsumed }) => {
  const appliances = [
    '1 ton AC',
    '1 ton Inverter AC',
    '1.5 ton AC',
  ...
  const ratings = [1500,900,2000,1200,2500,1500];
...
const totalElectricityBill = electricityBill.reduce(
 ...
 useEffect(() => {
  ...
  return (
    ...
    <div> <h1 style={{color: 'black',  marginTop: '130px', width: '100%', paddingBottom: '20px', paddingTop: '20px'}}>Electricity Bill Calculator</h1></div>
